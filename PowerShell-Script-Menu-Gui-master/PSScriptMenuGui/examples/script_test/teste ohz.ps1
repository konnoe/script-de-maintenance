# commande pour permetre au script de parler 

Add-Type -AssemblyName System.speech
$speak = New-Object System.Speech.Synthesis.SpeechSynthesizer

# commande lui permetant de dire ce qui y est ecrit

$speak.Speak("un instant s'il vous plait")
...
# commande pour les faire dire un mlsg de fin 

$speak.Speak("rangement de votre bureau terminer")